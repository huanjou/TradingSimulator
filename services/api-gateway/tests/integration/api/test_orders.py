...
@pytest.mark.parametrize("invalid_payload_updates, expected_status", [
...
@pytest.mark.asyncio
async def test_create_order_schema_validation(client, user_factory, invalid_payload_updates, expected_status):
